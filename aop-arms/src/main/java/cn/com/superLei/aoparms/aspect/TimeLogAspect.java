...
public class TimeLogAspect {
    ...
    @Pointcut("execution(@cn.com.superLei.aoparms.annotation.TimeLog * *(..))")//方法切入点
    public void methodAnnotated() {
    }

    @Pointcut("execution(@cn.com.superLei.aoparms.annotation.TimeLog *.new(..))")//构造器切入点
    ...
    public Object aroundJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Log.d("TimeLog", methodSignature.getMethod().getDeclaringClass().getCanonicalName());
